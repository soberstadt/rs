initialize ->
  myOptions =
    ...
    mapTypeId: google.maps.MapTypeId.ROADMAP
  	map = new google.maps.Map(document.getElementById("map-index"), myOptions)
...
# if we are showing a specific tab when opened
show = new Object()
...
double_click_driver(i) ->
	# setCurrentDriver(i);

double_click_rider(i) ->
	# if (current_driver != -1) {
	# 	addRider(i);
	# }
