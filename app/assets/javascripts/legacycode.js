	...
	*/
	...
	function initialize() {
		...
		<% @drivers.each do |driver| %>
			<% i=driver.id %>
			drivers[<%=i%>]=new Array();
			//drivers[<%=i%>]['marker']=new GMarker(new GLatLng(<%=driver.latitude%>,<%=driver.longitude%>), {title: "<%=driver.person.full_name%>", zIndexProcess: doZIndex, icon: <%=(driver.numbercurrentpassengers.to_i < driver.number_passengers)?"icons['driver']['available']":"icons['driver']['unavailable']"%>});
			...
			drivers[<%=i%>]['special_info']=<%=driver.special_info.to_json%>;
			drivers[<%=i%>]['show']=true;
		...
		<% @riders.each do |rider| %>
			...
			riders[<%=i%>]['special_info']=<%=rider.special_info.to_json%>;
			riders[<%=i%>]['show']=true;
...
// ----------------------------------------------------------------------------
	...
	/*
	no special prototyple libraries being imported
	*/
...
// prototype code in the public folder of the rails 2 application.
