...
Installing the mysql2 gem may be a little tricky. Just as a note, I am running MySQL 5.1.x, and 'gem install mysql2'. If you have a more difficult experience, Google is your best friend for trouble shooting. This is what that I did to install the mysql2 gem.