...
ActiveRecord::Schema.define(:version => 20121118195453) do
  ...
  create_table "rideshare_events", :force => true do |t|
    t.integer "conference_id"
  ...
  create_table "rideshare_ride_groups", :force => true do |t|
  ...
  create_table "rideshare_rides", :force => true do |t|
    t.integer "event_id"
  ...
  add_index "rideshare_rides", ["drive_willingness"], :name => "drivewillingness"
  add_index "rideshare_rides", ["driver_ride_id"], :name => "fk_driverID"
  add_index "rideshare_rides", ["event_id"], :name => "fk_eventID"
  add_index "rideshare_rides", ["person_id"], :name => "fk_personID"

  create_table "rideshare_travelers", :force => true do |t|
    t.string   "type"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
